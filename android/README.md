...
```gradle
dependencies {
    implementation 'com.github.apiverve:thesaurus-api:1.1.14'
}
```
...
```java
import com.apiverve.thesaurus.ThesaurusAPIClient;
import com.apiverve.thesaurus.APIResponse;
import com.apiverve.thesaurus.APIException;

// Initialize the client
ThesaurusAPIClient client = new ThesaurusAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "big");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/thesaurus](https://docs.apiverve.com/ref/thesaurus)
...
- **Documentation:** [https://docs.apiverve.com/ref/thesaurus](https://docs.apiverve.com/ref/thesaurus)
- **Issues:** [GitHub Issues](https://github.com/apiverve/thesaurus-api/issues)
