// Package thesaurus provides a Go client for the Thesaurus API.
//
// For more information, visit: https://thesaurus.apiverve.com?utm_source=go&utm_medium=readme
package thesaurus
...
const (
	baseURL        = "https://api.apiverve.com/v1/thesaurus"
	defaultTimeout = 30 * time.Second
)

// Client is the Thesaurus API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Thesaurus API client.
...
// Execute makes a request to the Thesaurus API with typed parameters.
//
...
//   - word (required): string - The word for which you want to get synonyms
